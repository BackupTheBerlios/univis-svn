//$Id: Ejb3DiscriminatorColumn.java 9572 2006-03-08 01:28:05Z epbernard $
...
public class Ejb3DiscriminatorColumn extends Ejb3Column {
	...
	public static Ejb3DiscriminatorColumn buildDiscriminatorColumn(
		...
		if ( discFormulaAnn != null ) {
			...
			if ( ! AnnotationBinder.isDefault( discAnn.name() ) ) discriminatorColumn.setLogicalColumnName( discAnn.name() );

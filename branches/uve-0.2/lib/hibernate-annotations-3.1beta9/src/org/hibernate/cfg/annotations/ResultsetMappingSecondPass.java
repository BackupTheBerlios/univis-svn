//$Id: ResultsetMappingSecondPass.java 9560 2006-03-07 11:36:38Z epbernard $
		...
		for ( EntityResult entity : ann.entities() ) {
			...
			for ( FieldResult field : entity.fields() ) {
				...
				if (name.indexOf( '.') == -1) {
					...
					if (pc == null)
						throw new MappingException( "Entity not found " + entity.entityClass().getName()
			...
			SQLQueryRootReturn result =
					new SQLQueryRootReturn( "alias" + entityAliasIndex++, entity.entityClass().getName(), propertyresults, LockMode.READ );

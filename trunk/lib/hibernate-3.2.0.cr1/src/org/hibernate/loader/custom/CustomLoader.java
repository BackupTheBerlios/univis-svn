//$Id: CustomLoader.java 9636 2006-03-16 14:14:48Z max.andersen@jboss.com $
...
public class CustomLoader extends Loader {
	...
	public ScrollableResults scroll(
		...
		return scroll(queryParameters, resultTypes, getHolderInstantiator(queryParameters.getResultTransformer(), getReturnAliasesForTransformer()), session);
	}
	...
	protected Object getResultColumnOrRow(
	        ...
	        ResultSet rs, SessionImplementor session) throws SQLException, HibernateException {
	...
	private String[] getReturnAliasesForTransformer() {
		if(discoveredColumnAliases!=null) {
			return discoveredColumnAliases;
		} else {

//$Id: SerializableToBlobType.java 7841 2005-08-11 06:52:19Z epbernard $
...
public class SerializableToBlobType extends AbstractLobType implements ParameterizedType {
	...
	@Override public boolean isEqual(Object x, Object y, EntityMode entityMode, SessionFactoryImplementor factory) {
		return type.isEqual(x, y);
	}


	@Override public int getHashCode(Object x, EntityMode entityMode, SessionFactoryImplementor session)  {
	...
	public void setParameterValues(Properties parameters) {
		if( parameters != null ) {
			...
			if (className == null) throw new MappingException("No class name defined for type: " + SerializableToBlobType.class.getName() );
			try {
